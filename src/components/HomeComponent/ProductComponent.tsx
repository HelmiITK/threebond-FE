  ...
  return (
    <div className="mt-6 mx-4 flex flex-col gap-8 lg:mx-10">
      ...
      <div className="flex items-center gap-2">
        ...
        <AiFillProduct size={20} className="text-gray-800"/>
      </div>
      {/* card product */}
      <div className="flex flex-col items-center gap-3">
        ...
        >
          ...
          <GoArrowUpRight className="w-4 h-4 text-blue-500 rotate-90 group-hover:rotate-[135deg] duration-150 ease-in-out" />
        </Link>
      </div>
    </div>
  );
